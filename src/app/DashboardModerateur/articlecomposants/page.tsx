...
const PageArticleAdmin = () => {
  ...
  const [moyenneEvaluations, setMoyenneEvaluations] = useState<number | null>(null);
  ...
  const handleArticleClick = async (articleId: string) => {
    ...
    try {
      ...
      const moyenne = await fetchMoyenneEvaluations(selectedCategory, articleId);
  ...
  const handleRefetchMoyenne = async (categorieId: string, articleId: string) => {
  ...
  const handleDeleteArticle = async (articleId: string, categorieId: string) => {
